...
library(utf8)
library(meta) # For metamean, etc for statistical analysis # https://cran.r-project.org/web/packages/meta/meta.pdf
...
# Load in data
rm(meta_data)
meta_data <- read_excel("data/model_pred_2LRV_UV_graph_abstract.xlsx", skip = 2)
...
# Graph it
png(file='UVforestplot_graphabstract.png',
    width = 8.5,
    height = 8.5,
    units = "in",
    res = 1200)
